...
## 📸 Screenshots
Home Feed	Profile	Search Users	Create Post
add_your_ss_here	add_your_ss_here	add_your_ss_here	add_your_ss_here

## 🚀 Features

🔐 Secure Authentication using Firebase Auth
📰 Real-time social feed using Cloud Firestore
🖼 Image and profile picture upload using Supabase Storage
👤 User profile with post history
➕ Follow and Unfollow users
👥 View followers and following count (tap to see full follower/following list like Instagram)
